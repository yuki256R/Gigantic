...
public class MineStackTableManager extends PlayerFromSeichiTableManager{
	public static enum StackConvert{
		...
		WOOD_STEP("wood_step0"),
		POLISHED_GRANITE,
		POLISHED_DIORITE,
		POLISHED_ANDESITE,
		SPRUCE_WOOD_STEP("wood_step1"),
		BIRCH_WOOD_STEP("wood_step2"),
		JUNGLE_WOOD_STEP("wood_step3"),
		ACACIA_WOOD_STEP("wood_step4"),
		DARK_OAK_WOOD_STEP("wood_step5"),
		FLINT,
