...
//全てのアイテム列挙
	...
	SAPLING(StackCategory.ITEM),
	SPRUCE_SAPLING(Material.SAPLING,1,StackCategory.ITEM),
	BIRCH_SAPLING(Material.SAPLING,2,StackCategory.ITEM),
	JUNGLE_SAPLING(Material.SAPLING,3,StackCategory.ITEM),
	ACACIA_SAPLING(Material.SAPLING,4,StackCategory.ITEM),
	DARK_OAK_SAPLING(Material.SAPLING,5,StackCategory.ITEM),
	...
	LEAVES(StackCategory.ITEM),
	SPRUCE_LEAVES(Material.LEAVES,1,StackCategory.ITEM),
	BIRCH_LEAVES(Material.LEAVES,2,StackCategory.ITEM),
	JUNGLE_LEAVES(Material.LEAVES,3,StackCategory.ITEM),
	...
	WEB(StackCategory.ITEM),
	//LONG_DEAD_GRASS(Material.LONG_GRASS,0,StackCategory.ITEM),
	LONG_GRASS(Material.LONG_GRASS,1,StackCategory.ITEM),
	FERN(Material.LONG_GRASS,2,StackCategory.ITEM),
	DEAD_BUSH(StackCategory.ITEM),
	...
	YELLOW_FLOWER(StackCategory.ITEM),
	RED_ROSE(StackCategory.ITEM),
	BLUE_ORCHID(Material.RED_ROSE,1,StackCategory.ITEM),
	ALLIUM(Material.RED_ROSE,2,StackCategory.ITEM),
	AZURE_BLUET(Material.RED_ROSE,3,StackCategory.ITEM),
	RED_TULIP(Material.RED_ROSE,4,StackCategory.ITEM),
	ORANGE_TULIP(Material.RED_ROSE,5,StackCategory.ITEM),
	WHITE_TULIP(Material.RED_ROSE,6,StackCategory.ITEM),
	PINK_TULIP(Material.RED_ROSE,7,StackCategory.ITEM),
	OXEYE_DAISY(Material.RED_ROSE,8,StackCategory.ITEM),
	BROWN_MUSHROOM(StackCategory.ITEM),
	RED_MUSHROOM(StackCategory.ITEM),
	...
	DOUBLE_PLANT(StackCategory.ITEM),
	LILAC(Material.DOUBLE_PLANT,1,StackCategory.ITEM),
	DOUBLE_TALLGRASS(Material.DOUBLE_PLANT,2,StackCategory.ITEM),
	LARGE_FERN(Material.DOUBLE_PLANT,3,StackCategory.ITEM),
	ROSE_BUSH(Material.DOUBLE_PLANT,4,StackCategory.ITEM),
	PEONY(Material.DOUBLE_PLANT,5,StackCategory.ITEM),
	...
	CHORUS_PLANT(StackCategory.ITEM),
	CHORUS_FLOWER(StackCategory.ITEM),
	...
	*/
	...
	SEEDS(StackCategory.ITEM),
	WHEAT(StackCategory.ITEM),
	...
	*/
	...
	BONE_MEAL(Material.INK_SACK,15,StackCategory.ITEM),
	...
	*/
	...
	CARROT_ITEM(StackCategory.ITEM),
	POTATO_ITEM(StackCategory.ITEM),
	...
	CHORUS_FRUIT(StackCategory.ITEM),
	CHORUS_FRUIT_POPPED(StackCategory.MATERIAL),
	BEETROOT(StackCategory.ITEM),
	BEETROOT_SEEDS(StackCategory.ITEM),
