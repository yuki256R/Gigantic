...
public class GuiStatusManager extends DataManager {
	...
	private Map<GuiMenuManager, String> SelectedCategory = new HashMap<GuiMenuManager, String>();
	...
	// メインメニューなどで選択した名前
	public void setSelectedCategory(GuiMenuManager menu, String category) {
		SelectedCategory.put(menu, category);
	}

	public String getSelectedCategory(GuiMenuManager menu) {
