...
import com.github.unchama.exchange.exchangers.GachaExchanger;
import com.github.unchama.exchange.exchangers.OreExchanger;

/**
 * Created by Mon_chi on 2017/06/17.
 */
public enum ExchangeType implements InventoryHolder {
	ORE(ChatColor.YELLOW + "不要鉱石景品交換システム",
			new String[] { ChatColor.GREEN + "不要な各種鉱石を", ChatColor.GREEN + "交換券と交換します" }, new ItemStack(
