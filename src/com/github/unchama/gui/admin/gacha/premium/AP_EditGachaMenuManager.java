 ...
 *
 */
public class AP_EditGachaMenuManager  extends AdminMenuManager{
	...
	public AP_EditGachaMenuManager() {
	...
	public boolean invoke(Player player, String identifier) {
		...
		if (tt.contains(CHOOSERARITYTITLE)) {
			...
			String ids = tt.replace(this.getInventoryName(player) + CHOOSERARITYTITLE + "(id=", "");
			ids = ids.replace(")", "");
			...
			Inventory inv = Bukkit.getServer().createInventory(player, 9,this.getInventoryName(player) +
					CHOOSERARITYTITLE + "(id=" + id + ")");
