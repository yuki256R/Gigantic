...
public final class Gigantic extends JavaPlugin {
	...
	public void onEnable() {
		...
		ItemStack mediumApple = GiganticItem.MANA_MEDIUM.getItemStack();
		ShapelessRecipe mediumRecipe = new ShapelessRecipe(mediumApple);
		mediumRecipe.addIngredient(9,GiganticItem.MANA_SMALL.getItemStack().getData());
		Bukkit.getServer().addRecipe(mediumRecipe);
	}
